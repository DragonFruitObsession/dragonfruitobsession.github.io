...
<head>
  <title>Jade Red Dragon Fruit - Dragon Fruit Obsession</title>
  <link href="varieties.css" type="text/css" rel="stylesheet">
  <meta name="description" content="Describing the Jade Red dragon fruit variety from all angles, including Variety Photos of the plant, buds, flowers and fruit.">
...
<body>
  <div class="grid-for-copyright">
    ...
    <div class="item-2">
      <small>&copy; Copyright 2020 - <script>
          document.write(new Date().getFullYear())
        </script>, Dragon Fruit Obsession</small>
      <div class="space"></div>
    </div>
  </div>
</body>
